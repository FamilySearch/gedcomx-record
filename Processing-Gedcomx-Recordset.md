      ...
      <tr>
        ...
        <td>
          <ol>
            ...
            <li>Look at the <code>original</code> or <code>formal</code> value(s) of the <code>temporal</code> property. (For more information on date formats, see the Gedcom X date format [spec] (/gedcomx/blob/master/specifications/date-format-specification.md/) .)</li>
          </ol>
          <h4>Example</h4>
          <pre>
